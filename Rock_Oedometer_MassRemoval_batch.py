...
def stopLoad():
    ...
    os.mkdir('../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/data')
    shutil.copy('data/'+O.tags['d.id']+'.txt','../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/data/'+O.tags['d.id']+'.txt')
    shutil.copy('data/IC_'+O.tags['d.id']+'.txt','../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/data/IC_'+O.tags['d.id']+'.txt')
    os.mkdir('../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/plot')
    shutil.copy('plot/'+O.tags['d.id']+'.png','../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/plot/'+O.tags['d.id']+'.png')
    shutil.copy('plot/IC_'+O.tags['d.id']+'.png','../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/plot/IC_'+O.tags['d.id']+'.png')
    shutil.copy('Rock_Oedometer_MassRemoval_batch.py','../Data_Rock_Oedometer_MassRemoval/'+O.tags['d.id']+'/Rock_Oedometer_MassRemoval_batch.py')
